...
ROLES = %w[leader member member member]
CATEGORIES = %w[Volunteer Donation Fundraiser]
TAGS = %w[
	Animals/Wildlife
	Children/Youth
	Disasters
...
user_banner =
	URI.open(
		'https://images.pexels.com/photos/1426718/pexels-photo-1426718.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
	)
DOUG.photos.attach(
	io: user_avatar,
...
org_logo =
	URI.open(
		'https://upload.wikimedia.org/wikipedia/commons/f/f0/Kokurenunhcrkyoukai.logo.jpg',
	)
UNHCR.photos.attach(
	io: org_logo,
	filename: 'org_logo.png',
...
org_banner =
	URI.open('https://pbs.twimg.com/profile_banners/14361155/1594242748/1500x500')
UNHCR.photos.attach(
	io: org_banner,
	filename: 'org_banner.jpg',
	content_type: 'image/jpg',
)
...
BASIC =
	Organization.create!(
		...
		address: 'Koyamadai, Shinagawa Tokyo 142-0061',
		description:
			"BASIC-Ph is a stress coping multiplex model developed by Israeli psychologist Dr. Moorie Lahad. Dr. Lahad developed this model not by focusing on the pathology of why people failed, but by the resilience of how people got over it and how they got over it.
...
org_logo =
	URI.open(
		'https://i.pinimg.com/564x/e4/6f/7a/e46f7abd46d41f4f122920e453a5756a.jpg',
	)
BASIC.photos.attach(
	io: org_logo,
	filename: 'org_logo.png',
...
org_banner =
	URI.open(
		'https://scontent.fkix2-1.fna.fbcdn.net/v/t31.0-8/11109617_696322313829076_5142896223092437756_o.jpg?_nc_cat=104&ccb=2&_nc_sid=6e5ad9&_nc_ohc=SvjKVVBbMCQAX-KC2I5&_nc_ht=scontent.fkix2-1.fna&oh=d074ff0fb496bb69e901ac261a54df7b&oe=5FF08F32',
	)
BASIC.photos.attach(
	io: org_banner,
	filename: 'org_banner.jpg',
...
org_logo =
	URI.open(
		'https://image.shutterstock.com/image-vector/world-wildlife-day-march-3-260nw-573200827.jpg',
	)
WWLD.photos.attach(
	io: org_logo,
	filename: 'org_logo.png',
...
org_banner =
	URI.open(
		'https://www.wildlifeday.org/sites/all/themes/wildlifeday/images/theme/bg-top-images/top-bg-2v3.png?v=1.1',
	)
WWLD.photos.attach(
	io: org_banner,
	filename: 'org_banner.jpg',
...
org_banner =
	URI.open(
		'https://www.unicef.org/sites/default/files/styles/media_banner/public/2018-02/02_WWD_UNI174116_Bluewash_WEB.jpg?itok=UIq70818',
	)
UNICEF.photos.attach(
	io: org_banner,
	filename: 'org_banner.jpg',
...
org_logo =
	URI.open(
		'https://venngage-wordpress.s3.amazonaws.com/uploads/2019/04/nonprofit-logo.png',
	)
HANDS.photos.attach(
	io: org_logo,
	filename: 'org_logo.png',
...
org_banner =
	URI.open('https://www.flipcause.com/uploads/5c4b59f8dc9a8_bannerpng')
HANDS.photos.attach(
	io: org_banner,
	filename: 'org_banner.jpg',
	content_type: 'image/jpg',
...
org_logo =
	URI.open(
		'https://scontent-nrt1-1.xx.fbcdn.net/v/t31.0-0/cp0/e15/q65/p320x320/468508_472465212841537_1329765003_o.jpg?_nc_cat=111&ccb=2&_nc_sid=85a577&_nc_ohc=ARlhtRjjai8AX8L2csN&_nc_ht=scontent-nrt1-1.xx&tp=3&oh=3097b736dab1e40e7858b984ae47b04b&oe=5FE2A19D',
	)
MORI.photos.attach(
	io: org_logo,
	filename: 'org_logo.png',
...
org_banner =
	URI.open(
		'https://pbs.twimg.com/profile_banners/3220941001/1556172024/1500x500',
	)
MORI.photos.attach(
	io: org_banner,
	filename: 'org_banner.jpg',
...
POLAR_BEARS =
	Event.create!(
		...
		category: 'Fundraiser',
		description:
			'Donate to World Wildlife Day to help raise awareness and support scientific research and initiatives that help determine a way on how to save polar bears from global warming. Charity Navigator gives the charity an 82.51 score out of 100, with 77 percent of the money it raises going directly to programs and services that help their mission.',
		positions: rand(3..10),
		address: 'Alaska, United States',
		ongoing: true,
		dates: [0, 1, 2, 3, 4, 5, 6].sample(rand(1..7)).sort,
		start_time: Time.now + rand(10_000..100_000),
...
event_photo =
	URI.open(
		'https://media.pri.org/s3fs-public/styles/story_main/public/migration/PriMigrationsVivvoFilesImagesMigration/pri.org/files/640px_Polar_Bear_ANWR_1_400523505.jpeg?itok=yFqRPxTs',
	)
POLAR_BEARS.photo.attach(
	io: event_photo,
	filename: 'event.jpg',
	content_type: 'image/jpg',
)
...
event_photo =
	URI.open(
		'https://i0.wp.com/centraldigest.com/wp-content/uploads/2017/12/2016-03-28-1459180714-4846885-cannedfood2-thumb.jpg?resize=406%2C304&ssl=1',
	)
FOOD.photo.attach(
	io: event_photo,
	filename: 'event.jpg',
...
CHRISTMAS =
	Event.create!(
		...
		category: 'Donation',
		description:
			"There’s nothing quite like Christmas to bring out the kid in everyone. Holiday cards, gift giving and receiving, stuffed animals and other toys, hoping for that perfect gift from someone special — the Christmas season is a special time of year.
...
event_photo =
	URI.open(
		'https://www.theguardian.pe.ca/media/photologue/photos/cache/20141217-santas-angels-2777820_large.jpg',
	)
CHRISTMAS.photo.attach(
	io: event_photo,
	filename: 'event.jpg',
	content_type: 'image/jpg',
)
